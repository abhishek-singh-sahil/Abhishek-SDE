...
const seedDatabase = async () => {
  try {
    ...
    const projectsData = [
      ...
      {
        title: 'TNT Collaboration Tool',
        slug: 'tnt-collab',
        description: 'An optimized dashboard utility application built for team collaborations and role compatibility tracking.',
        clientName: 'TNT Tech Group',
        category: 'Web Apps',
        tags: ['React', 'Node.js', 'Express.js', 'MongoDB'],
        coverImage: '/uploads/tnt-cover.png',
        screenshots: [],
        liveUrl: 'https://tnt-six-mocha.vercel.app',
        githubUrl: 'https://github.com/abhishek-singh-sahil/TNT',
        completionDate: new Date('2026-08-15'),
        challenges: 'Handling complex object states and ensuring absolute security on client role updates.',
        solution: 'Integrated custom role validator middlewares and sanitization utilities.',
        results: 'Simplified workflow tracking for team users and optimized background function responses.',
        isFeatured: true,
        isPublished: true,
        order: 3,
      },
      {
        ...
        slug: 'anand-vihar',
        description: 'A housing complex administrative platform offering unified community updates and Google OAuth security integrations.',
        clientName: 'Anand Vihar Association',
        category: 'Web Apps',
        tags: ['React', 'Google OAuth', 'Node.js', 'MongoDB'],
        coverImage: '/uploads/anandvihar-cover.png',
        screenshots: [],
        liveUrl: 'https://anand-vihar.vercel.app',
        ...
        results: 'Allowed 100+ families to register and view administrative logs with zero friction.',
        isFeatured: false,
        isPublished: true,
        order: 4,
      },
