...
const seedDatabase = async () => {
  try {
    ...
    const projectsData = [
      {
        title: 'PixelShop E-Commerce',
        slug: 'pixelshop-ecommerce',
        description: 'A fully functional online retro game shop with custom cart state, payment options, and invoice generator.',
        clientName: 'RetroQuest Ltd.',
        category: 'E-commerce',
        tags: ['React', 'Tailwind CSS', 'Node.js', 'MongoDB', 'Stripe'],
        coverImage: '/uploads/project1-cover.png',
        screenshots: ['/uploads/project1-shot1.png', '/uploads/project1-shot2.png'],
        liveUrl: 'https://pixelshop.example.com',
        githubUrl: 'https://github.com/example/pixelshop',
        completionDate: new Date('2026-03-15'),
        challenges: 'Building dynamic inventory syncing across multiple checkout routes, and maintaining fast image uploads.',
        solution: 'Implemented MongoDB transactions to update inventory quantities safely during Stripe payments, combined with React dynamic page loading.',
        results: 'Boosted client conversions by 32% and achieved a Lighthouse loading score of 98/100.',
        isFeatured: true,
        isPublished: true,
        order: 1,
      },
      {
        title: 'Voxel CMS Platform',
        slug: 'voxel-cms-platform',
        description: 'A custom content management system allowing retro-game content creators to write blogs with built-in markdown editors and widgets.',
        clientName: '8BitMedia Inc.',
        category: 'Web Apps',
        tags: ['React', 'Express.js', 'Mongoose', 'Markdown'],
        coverImage: '/uploads/project2-cover.png',
        screenshots: ['/uploads/project2-shot1.png'],
        liveUrl: 'https://voxelcms.example.com',
        githubUrl: 'https://github.com/example/voxel-cms',
        completionDate: new Date('2026-06-20'),
        challenges: 'Enabling absolute secure markdown previews without risking XSS injections on custom retro code widgets.',
        solution: 'Integrated custom DOMPurify and strict state validation rules inside Express middleware before storing content in database.',
        results: 'Saved authors 40% of their time writing posts and has zero security breaches since rollout.',
        isFeatured: true,
        isPublished: true,
        order: 2,
      },
